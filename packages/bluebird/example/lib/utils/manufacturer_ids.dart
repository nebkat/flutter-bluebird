...
// Bluetooth SIG Company Identifiers (manufacturer/company IDs).
// Source: NordicSemiconductor/bluetooth-numbers-database (v1/company_ids.json).

/// Maps a 16-bit Bluetooth SIG company identifier to its assigned name.
