...
sealed class OpKey {
    ...
    enum class CharOpKind { READ, WRITE, NOTIFY }
    enum class DescOpKind { READ, WRITE }
    ...
    data class CharOp(override val address: String, val kind: CharOpKind, val key: CharKey) : OpKey()
    data class DescOp(
